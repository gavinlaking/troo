...
module Trlo
  describe ExternalMember do
    ...
    #     Trlo::ExternalMember.request("526d8f19ddb279532e005259", {is_member_id: true}).size must_equal 1
    #   end
    # end
    ...
    #     Trlo::ExternalMember.request("526d8e130a14a9d846001d96").size must_equal 17
    #   end
    # end
  end
end
